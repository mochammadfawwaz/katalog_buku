      ...
      <form class="form-horizontal" action="index.php?include=konfirmasi-edit-buku" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
              ...
              <select class="form-control" id="penerbit" name="penerbit">
                ...
                <?php
                  ...
                  while($data_t = mysqli_fetch_row($query_t)) {
                    ...
                    $terbit = $data_t[1];
                ?>
                  <option value="<?php echo $id_terbit; ?>" <?php if($id_terbit == $id_penerbit) { ?> select <?php }?>><?php echo $terbit;?></option>
                  <?php }?>
              </select>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="date" class="form-control" name="tahun_terbit" id="tahun_terbit" value="<?php echo $tahun_terbit; ?>">
            </div>
          </div>
          <div class="form-group row">

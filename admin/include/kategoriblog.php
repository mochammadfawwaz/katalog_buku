                ...
                <table class="table table-bordered">
                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center">
                        <a href="index.php?include=edit-kategori-blog&data=<?php echo $id_kategori_blog;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> </a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>'))window.location.href='index.php?include=kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog; ?>&if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>  
                      </td>
                    </tr>
                    <?php   
                    $no++; }
              ...
              <div class="card-footer clearfix">
                ...
                <?php 
                    if($jum_halaman == 0) {
                      ...
                      if($halaman != 1) {
                        echo "
                        <li class='page-item'><a class='page-link' href='index.php?include=kategori-blog&halaman=1'>First</a></li>";

              ...
              <?php if(!empty($_GET['notif'])) {?>
                ...
                <table class="table table-bordered">
                  ...
                  if(isset($_POST["katakunci"])) {
                    ...
                    $sql_k = "SELECT `id_konten`,`judul`, `isi`, `tanggal` FROM
                    `konten` ";
                  ...
                  ?>
                    <tr>
                      ...
                      <a href="index.php?include=detail-konten&data=<?php echo $id_konten; ?>" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $judul; ?>'))window.location.href='index.php?include=konten&aksi=hapus&data=<?php echo $id_konten; ?>&if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>     
                      </td>
                    </tr>
                    <?php   
                    $no++; }
              ...
              <div class="card-footer clearfix">
                ...
                <?php 
                    if($jum_halaman == 0) {
                      ...
                      if($halaman != 1) {
                        echo "
                        <li class='page-item'><a class='page-link' href='index.php?include=konten&halaman=1'>First</a></li>";

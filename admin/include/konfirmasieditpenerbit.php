...
if(isset($_SESSION['id_penerbit'])){
    ...
    $alamat = $_POST['alamat'];
 if(empty($penerbit)) {
    header("Location:index.php?include=edit-penerbit&data=".$penerbit."&notif=editkosong");
 }else if(empty($alamat)) {
    header("Location:index.php?include=edit-penerbit&data=".$alamat."&notif=editkosong");
 }else{

                ...
                <table class="table table-bordered">
                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center">
                        <a href="index.php?include=edit-kategori-buku&data=<?php echo $id_kategori_buku;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> </a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>'))window.location.href='index.php?include=kategori-buku&aksi=hapus&data=<?php echo $id_kategori_buku; ?>&if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>  
                      </td>
                    </tr>
                    <?php   
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                  <?php 
                    if($jum_halaman == 0) {
                      ...
                      if($halaman != 1) {
                        echo "
                        <li class='page-item'><a class='page-link' href='index.php?include=kategori-buku&halaman=1'>First</a></li>";

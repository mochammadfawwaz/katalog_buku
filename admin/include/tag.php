                ...
                <table class="table table-bordered">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $tag; ?></td>
                      <td align="center">
                        <a href="index.php?include=edit-tag&data=<?php echo $id_tag;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> </a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $tag; ?>'))window.location.href='index.php?include=tag&aksi=hapus&data=<?php echo $id_tag; ?>&if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>     
                      </td>
                    </tr>
                    <?php $no++; } ?>
                  </tbody>
              ...
              <div class="card-footer clearfix">
                ...
                <?php 
                    if($jum_halaman == 0) {
                      ...
                      if($halaman != 1) {
                        echo "
                        <li class='page-item'><a class='page-link' href='index.php?include=tag&halaman=1'>First</a></li>";

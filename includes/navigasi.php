<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?include=about">About Us</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown07">
                        ...
                        while ($data_k = mysqli_fetch_row($query_k)) {
                            $id_kat = $data_k[0];
                            $kat = $data_k[1]; ?>
                            <a class="dropdown-item" href="index.php?include=detail-kategori-buku&data=<?= $id_kat; ?>"> <?php echo $kat; ?></a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?include=contact">Contact Us</a>
                </li>
            </ul>
